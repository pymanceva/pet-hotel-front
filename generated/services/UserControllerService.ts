...
xPetHotelUserId: number,
        ...
        return __request<any>(UserControllerOptions.getAllUsers(
        xPetHotelUserId,
));
    }
    /**
...
requestBody: IUserDto,
        ...
        return __request<any>(UserControllerOptions.addUser(
        xPetHotelUserId,
        requestBody,
));
    }
...
id: number,
        ...
        return __request<any>(UserControllerOptions.getUserById(
        xPetHotelUserId,
        id,
));
    }
...
id: number,
        ...
        return __request<void>(UserControllerOptions.deleteUserById(
        xPetHotelUserId,
        id,
));
    }
...
requestBody: IUpdateUserDto,
        ...
        return __request<any>(UserControllerOptions.updateUser(
        xPetHotelUserId,
        id,
        requestBody,
));
...
isActive: boolean,
        ...
        return __request<any>(UserControllerOptions.setUserState(
        xPetHotelUserId,
        id,
        isActive,
));
