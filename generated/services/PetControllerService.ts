...
requestBody: INewPetDto,
        ...
        return __request<IPetDto>(PetControllerOptions.addPet(
        xPetHotelUserId,
        requestBody,
));
    }
...
petId: number,
        ...
        return __request<IPetDto>(PetControllerOptions.getPetById(
        xPetHotelUserId,
        petId,
));
    }
...
petId: number,
        ...
        return __request<void>(PetControllerOptions.deletePet(
        xPetHotelUserId,
        petId,
));
    }
...
requestBody: IUpdatePetDto,
        ...
        return __request<IPetDto>(PetControllerOptions.updatePet(
        xPetHotelUserId,
        petId,
        requestBody,
));
